...
export const impassableTiles = new Set([
    2001, 2002, 2003, 2004, 4001, 4002, 4003, 4004, 4005, 4006, 4007, 4009, 4010, 4111
]);
...
export const specialTransitions = {
    map002: { '11,11': { nextMap: 'map002HA', spawnX: 8, spawnY: 13 } },
    map002HA: { '8,13': { nextMap: 'map002', spawnX: 11, spawnY: 11 } }
};
